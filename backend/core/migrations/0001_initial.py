    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('credits_per_semester', models.PositiveIntegerField(default=24)),
            ],
        ),
        migrations.CreateModel(
            name='User',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('recipients', models.ManyToManyField(blank=True, to='core.direction')),
            ],
        ),
        migrations.CreateModel(
            name='Semester',
            fields=[
                ...
                ('direction', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='semesters', to='core.direction')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('direction', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='subjects', to='core.direction')),
                ('professor', models.ForeignKey(blank=True, limit_choices_to={'role': 'professor'}, null=True, on_delete=django.db.models.deletion.SET_NULL, to=settings.AUTH_USER_MODEL)),
